...
# File: my_cpu.tcl
# Generated on: Sat Nov 12 07:50:57 2022
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "my_cpu"]} {
		puts "Project my_cpu is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists my_cpu]} {
		project_open -revision lcd-working my_cpu
	} else {
		project_new -revision lcd-working my_cpu
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "08:40:06  AUGUST 31, 2022"
	...
	set_global_assignment -name SYSTEMVERILOG_FILE lcd_ctrl.sv
	set_global_assignment -name QIP_FILE lcd_cmd.qip
	set_global_assignment -name SYSTEMVERILOG_FILE analog_input.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Screens_dispaly.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Top_template.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Draw_Intel.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Drawing_priority.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Move_Intel.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Draw_Ghost.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Move_Ghost.sv
	set_global_assignment -name SYSTEMVERILOG_FILE periphery_control.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Intel_unit.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Ghost_unit.sv
	set_global_assignment -name SYSTEMVERILOG_FILE CPU.sv
	set_global_assignment -name SYSTEMVERILOG_FILE RAM.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Video_Buffer.sv
	set_global_assignment -name SYSTEMVERILOG_FILE Time_Base_Counter.sv
